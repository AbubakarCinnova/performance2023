  ...
  <ol class="carousel-indicators">
    ...
    <li data-target="#carousel-example-generic" data-slide-to="4"></li>  
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                <a href="request-service.php"> <img src="<?php echo $base_url; ?>/img/we_do_it.jpg" alt="second slide"
                        width="100%"> </a>
            </div>
            <div class="item">
                <a href="request-service.php"> <img src="<?php echo $base_url; ?>/img/FALL_REBATE_LENNOX (1) (2).png"
                        alt="third slide" width="100%"> </a>
            </div>
            <div class="item">
                <a href="request-service.php"> <img
                        src="<?php echo $base_url; ?>/img/Fall_Furnace_TuneUp_1000_350_V2 (1) (1).jpg"
                        alt="fourth slide" width="100%"> </a>
            </div>
            ...
            <div class="col-lg-2 col-sm-4">
                <div class="text-center blue-boxes">
                    <a href="<?php echo $base_url ?>/heat-pumps.php">
                        <div class="icon">
                            <img src="<?php echo $base_url ?>/img/heat pump (1).png" alt="" class="img-responsive">
                        </div>
                        <h4>Heat <br> Pumps</h4>
                        <p> </p>
                    </a>
            ...
            <div class="col-lg-2 col-sm-4">
                <div class="text-center blue-boxes">
                    <a href="<?php echo $base_url ?>/mini-split.php">
                        <div class="icon">
                            <img src="<?php echo $base_url ?>/img/mini-splits-unit-image-transparent (2).png" alt=""
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p>Performance Heating and Cooling is the premier HVAC company in the Heath, Ohio area. Since 2005,
                        ...
                        conditioning services. We are a family-owned and operated business that has built its reputation
                        on high quality, value, and a worry-free customer experience. Our NATE-certified HVAC
                        technicians are at the top of their field and continually receive training to improve their
                        knowledge. From routine maintenance to emergency repairs to quality installation of
                        high-efficiency home comfort systems, give us a call today!</p>
        ...
        <div class="container">
            ...
            <div id="testmonial" class="owl-carousel">
                ...
                <div class="col-sm-12 item  owl-item">
                    ...
                    <p class="light text-center ">I have been using this company for my HVAC work for 1-2 years, have
                        always been
                        very responsive, excellent work, reasonable prices. Can’t put a price on trust in knowing it
                        will be done
                        right.</p>
                ...
                <div class="col-sm-12 item  owl-item">
                    ...
                    <p class="light text-center ">
                    <p class="light text-center ">Great experience! We had both our furnace and A/C replaced. Proposal
                        included
                        options, and suggestions were given as to what would work best for us. The installation only
                        took one day.
                    </p>
                ...
                <div class="col-sm-12 item  owl-item">
                    ...
                    <p class="light text-center ">
                    <p class="light text-center ">Love our new furnace and AC!! The service we received before during
                        and after
                ...
                <div class="col-sm-12 item  owl-item">
                    ...
                    <p class="light text-center ">
                    <p class="light text-center ">Performance responded quickly to our issues with both the heating and
                        air
