<?php $base_url  = "http://stage.reticlewebmarketing.com/performance2023"; ?>
    ...
    <div class="row">
      ...
      <div class="container">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 pull-right">
          ...
          <ul class="list-unstyled list-inline navbar-right quick-links">


            <li><a href="https://www.facebook.com/Performancehcs/" target="_blank"><img src="<?php echo $base_url ?>/img/facebook.png" style="width: 5%; float: right;"></a>
            <a href="https://www.instagram.com/performanceheatingandcooling/"><img src="<?php echo $base_url ?>/img/instagram.png" style="width: 5%;float: right;margin-right: 10px;"> </a>
          </li>
